<template>
      ...
      <div  @click="$router.go(-1)" class="type-list">
        ...
        <div v-else-if="selectedItem">
          ...
          <div v-if="selectedItem?.company">
            ...
            <div class="topic-text">{{ selectedItem?.company}}
            <div class="text">Role: {{ selectedItem?.role }}</div>
          </div>
  ...
  export default defineComponent({
    ...
    data() {
      return {
        info_list: [] as Jobworks[],
        loading: true,
        selectedItem: null as Jobworks | null,
        currentLink: '',
        videoId: '',
      };
    },
    ...
    methods: {
      getItemById(json: { contents: Jobworks[] }, id: string): Jobworks | undefined {
